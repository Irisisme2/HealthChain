...
import {
  ...
  lineChartDataBloodSugar,
  lineChartOptionsBloodSugar,
    ...
    >
      ...
      <Flex w="100%" flexDirection={{ base: "column", lg: "row" }}>
        ...
        <Box minH="260px" minW="75%" mt="auto">
          <LineChart
            chartData={lineChartDataBloodPressure}
            chartOptions={lineChartOptionsBloodPressure}
          />
        </Box>
      </Flex>
      <Flex w="100%" flexDirection={{ base: "column", lg: "row" }} mt="20px">
        ...
        <Box minH="260px" minW="75%" mt="auto">
          <LineChart
            chartData={lineChartDataBloodSugar}
            chartOptions={lineChartOptionsBloodSugar}
          />
        </Box>
      </Flex>
    </Card>
